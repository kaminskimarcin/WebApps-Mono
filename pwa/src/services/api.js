...
// Pomocnicza funkcja do pobierania tokena JWT aktualnie zalogowanego użytkownika
...
// Główne zapytanie z wpiętym Bearer Tokenem
async function fetchWithAuth(endpoint, options = {}) {
  ...
  // W przypadku DELETE zazwyczaj nie ma JSONa w odp.
